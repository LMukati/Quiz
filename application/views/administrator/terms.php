...
<div class="main-content">
   <div class="content-wrapper"><!--Statistics cards Starts-->
      ...
      <div class="row">
    <div class="col-12">
        <div class="content-header">Manage Terms & Conditions
        </div>
                ...
                <div class="card-body">
                    <div class="card-block">
                         <form class="form" action="" method="post" enctype="multipart/form-data">
							<div class="form-body">
                                <h4 class="form-section"><i class="fa fa-bullhorn" aria-hidden="true"></i> Update Terms & conditions</h4>
                                
                                <div class="col-md-12"  style="float:left">
                                    <div class="form-group">
                                        <label >About</label>
                                        <textarea class="form-control" name="terms" id="description" required rows="10"><?php if(isset($view)){ echo $view->terms ; } ?></textarea>
                                    </div>
                                </div>
                            </div>
