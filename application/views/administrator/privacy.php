...
<div class="main-content">
   <div class="content-wrapper"><!--Statistics cards Starts-->
      ...
      <div class="row">
    <div class="col-12">
        <div class="content-header">Manage Privacy policy
        </div>
                ...
                <div class="card-body">
                    <div class="card-block">
                         <form class="form" action="" method="post" enctype="multipart/form-data">
							<div class="form-body">
                                <h4 class="form-section"><i class="fa fa-bullhorn" aria-hidden="true"></i> Update Privacy</h4>
                                
                                <div class="col-md-12"  style="float:left">
                                    <div class="form-group">
                                        <label >Privacy policy</label>
                                        <textarea class="form-control" name="privacy" id="description" required rows="10"><?php if(isset($view)){ echo $view->privacy ; } ?></textarea>
                                    </div>
                                </div>
                            </div>
