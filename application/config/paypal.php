 ...
 *
 */
$config['APIUsername'] = $config['Sandbox'] ? 'prajapativijay2601-facilitator_api1.gmail.com' : 'PRODUCTION_USERNAME_GOES_HERE';
$config['APIPassword'] = $config['Sandbox'] ? 'UVUTJAHXCNDGFQPA' : 'PRODUCTION_PASSWORD_GOES_HERE';
$config['APISignature'] = $config['Sandbox'] ? 'AFcWxV21C7fd0v3bYYYRCpSSRl31Au6emwd32xgaFwHNRuibG7MflQiV' : 'PRODUCTION_SIGNATURE_GOES_HERE';
